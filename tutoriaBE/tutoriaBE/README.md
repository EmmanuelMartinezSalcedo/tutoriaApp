...
To update the database use this command from the Web project folder (replace `tutoriaBE` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../tutoriaBE.Infrastructure/tutoriaBE.Infrastructure.csproj -s tutoriaBE.Web.csproj
```
